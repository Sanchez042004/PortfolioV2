  ...
  const projectCards = projects.map(project => `
    <article class="card project-card">
      <img 
        ...
        alt="${project.title}" 
        class="card-image project-image"
        ...
        <div class="project-footer">
           ...
           <div class="project-buttons">
             ${project.link && project.link !== '#' ? `
               <a href="${project.link}" target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-outline flex items-center gap-xs" aria-label="${t('projects.viewCode')}">
                 ${githubIcon}
                 ${t('projects.viewCode')}
               </a>
             ` : ''}
